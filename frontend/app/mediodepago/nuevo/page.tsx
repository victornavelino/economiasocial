...
import { createMedioDePago } from '@/app/services/api';
import { ArrowLeft, Save, Loader2 } from 'lucide-react';

const PRIMARY = '#1a6fa0';

export default function NuevoMedioDePagoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      await createMedioDePago({ nombre: nombre.trim() });
      ...
      <div className="bg-white border-b border-slate-200 sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-xl font-bold text-slate-800">Nuevo Medio de Pago</h1>
          </div>
        </div>
      </div>
