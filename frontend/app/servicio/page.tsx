...
import { getServicios, deleteServicio } from '@/app/services/api';
import { Edit, Trash2, Plus, Scissors, Search, ChevronRight } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {!loading && !error && filtered.length === 0 && (
          <div className="text-center py-16 bg-white rounded-xl border border-slate-200 border-dashed">
            <Scissors className="w-12 h-12 mx-auto mb-3 opacity-20 text-slate-400" />
                ...
                <div className="p-4 flex flex-col h-full">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <Link href={`/servicio/${item.id}/editar`}>
